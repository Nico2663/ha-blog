    ...
    <div id="admin-post" class="container content">
        ...
        <form action="{{ url('/admin/articulos/crear') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" placeholder="Ingresar un título..." value="{{ old('title') }}" required>
            </div>
            {{-- <div class="form-group">
                <label for="author">Autor</label>
                <input type="text" class="form-control" id="author" name="author" placeholder="Ingresar autor...">
            </div> --}}
            <div class="form-group">
                <label for="author">Usuario (Autor)</label>
